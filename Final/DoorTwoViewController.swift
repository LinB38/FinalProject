...
class DoorTwoViewController: UIViewController {
    ...
    @IBAction func govDoorOnePressed(_ sender: Any) {
    }
    @IBAction func govDoorTwoPressed(_ sender : Any){
    }
    @IBAction func govCameraPressed(_ sender : Any) {
    }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        nameLabel.text = "John"
        textLabel.text = "Looks like nobody's been down here for a long time..."
